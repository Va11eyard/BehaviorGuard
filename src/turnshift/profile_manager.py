...
class ProfileManager:
    ...
    This is the implementation of Algorithm 1 from the TurnShift paper:
    ...
    def __init__(
        ...
        from turnshift.embedding_config import EMBEDDING_MODEL_NAME
    ...
    def build_from_history(
        ...
        Returns:
            A UserProfile ready to be used by TurnShiftEvaluatorML.
        """
