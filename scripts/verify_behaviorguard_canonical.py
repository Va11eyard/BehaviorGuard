#!/usr/bin/env python3
"""
Verify BehaviorGuard canonical Table III row reproduces from evaluate_method().

Canonical config: EMA λ=0.50 (ProfileManager), overrides disabled, τ=0.60.

Usage:
    python scripts/verify_behaviorguard_canonical.py
"""
...
def main() -> None:
    ...
    print("=" * 80)
    print("BehaviorGuard canonical reproduction (λ=0.50, overrides OFF, τ=0.60)")
    print("=" * 80)
